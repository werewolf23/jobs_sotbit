...
if ($arParams["SEARCH_PAGE"])
{
	...
	{
        if (empty($arResult["META_SPECIALDATE_VALUE"])){
            $arResult["META_SPECIALDATE_VALUE"] = $arItem["TIMESTAMP_X"];

            $this->__component->arResult["META_SPECIALDATE_VALUE"] = $arItem["TIMESTAMP_X"];
            $this->__component->SetResultCacheKeys(['META_SPECIALDATE_VALUE']);
        }
